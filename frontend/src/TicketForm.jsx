...
export default function TicketForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (!reference.trim()) throw new Error("Enter your Hubtel payment reference");
            // 1️⃣ Verify with Hubtel and create ticket via backend
    ...
    return (
        <div>
            <form onSubmit={handleSubmit} className="ticket-form">
                ...
                <input
                    type="text"
                    placeholder="Hubtel Payment Reference"
                    value={reference}
                ...
                <button type="submit" disabled={loading}>
                    {loading ? "Verifying Payment..." : "Generate Ticket"}
                </button>
